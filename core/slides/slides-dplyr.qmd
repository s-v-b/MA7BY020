...
```{r , ref.label="glimpse-schema"}
#| label: glimpse-schema-out
#| echo: false
#| eval: true
```
...
{{< fa hand-point-right >}} `|>` is the pipe operator from `magrittr`
...
![](/images/schema-nycflights.png){width="60%"}
...
```{r, ref.label="flights-weather"}
#| label: flights-weather-out
#| eval: true
#| echo: false
```
