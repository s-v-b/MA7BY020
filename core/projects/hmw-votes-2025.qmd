...
format:
  html:
    output-file: hmw-votes-2026.html
  pdf:
    output-file: hmw-votes-2026.pdf
...
- {{< fa desktop >}} Present your work (15 minutes) on *2026-06-03* 
...
2. Investigating  voting patterns in Paris (or elsewhere)
...
scrutins <-  dplyr::bind_rows(
  ...
  tibble::tibble(title='Local', rounds=2, year=c(2001, seq(2008, 2020, 6))),# 2026 ???
